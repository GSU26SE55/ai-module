...
## SohDegradation
- **Threshold:** SOH < 80% = End-of-Life; 80-85% = Maintenance Required tier;
  85-90% = early degradation watch tier.
...
- **Response:** map directly to `action_code_sop.md` — 85-90% → `MONITOR`,
  80-85% → `SCHEDULE_REPLACEMENT`, <80% → `REPLACE_IMMEDIATELY`. See
  `battery_maintenance_sop.md` §1 for the full inspection interval table.
...
- IEEE Std 1188-2014 — Maintenance, Testing, and Replacement of VRLA
  Batteries (interval/checklist methodology).
